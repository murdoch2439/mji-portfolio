                ...
                <div className={"about__content"}>
                    ...
                    <div>
                        <p className={"about__p"}>
                            ...
                            Whether the outcome is a website, a web product, or a mobile experience, I start from the problem, the users, and the constraints, then design and build a solution that fits how your organization actually works.
                        </p>
                        <p className={"about__p"}>
